...
module.exports = function (ctx) {
  return {
    ...
    build: {
      ...
      env: ctx.dev
        ? { // so on dev we'll have these environment variables
          ...
          BLOCKNATIVE_API_KEY: JSON.stringify("df6bc329-8c80-40a9-93be-8ed71c3eac6d"),
    ...
    pwa: {
      ...
      manifest: {
        name: 'Bancor Fiat On Ramp',
        short_name: 'Bancor Fiat On Ramp',
        description: 'Fiat on/off ramps for entering/exiting Bancor liquidity pools',
        display: 'standalone',
